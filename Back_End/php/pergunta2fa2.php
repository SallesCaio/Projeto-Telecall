...
if (isset($_POST["submit"]) && empty($errors)) {
    ...
    function verificarResposta($resposta, $pergunta, $id, $conexao)
    {
        ...
        if ($pergunta == "data_nascimento") {
            $query = "SELECT id FROM usuario WHERE data_nascimento = '$resposta' AND id = '$id'";
        } else {
...
<body>
    <div class="main-login">
            <form action="pergunta2fa2.php" id="form" class="right-login" method="post">
            <div class="card">
            <a href="login.php"><img src=../imagens/telecall_logo.png width="100rem"></a>
                ...
                <div class="texto">
                    ...
                    <input type="text" name="resposta" class="required" placeholder="Informe a Data de Nascimento.">
