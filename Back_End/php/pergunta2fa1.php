...
if (isset($_POST["submit"]) && empty($errors)) {
    ...
    function verificarResposta($resposta, $pergunta, $id, $conexao)
    {
        ...
        if ($pergunta == "cep") {
            $query = "SELECT id FROM usuario WHERE cep = '$resposta' AND id = '$id'";
        } else {
    ...
    if ($userInfo) {
        ...
        $conexao->close();
        $_SESSION["role"] = "erro";
        $_SESSION["message"] = "Você errou a pergunta de segurança.";
        header("Location: erro.php");
    }
}
...
<body>
    <div class="main-login">
            <form action="pergunta2fa1.php" id="form" class="right-login" method="post">
            <div class="card">
                <a href="login.php"><img src=../imagens/telecall_logo.png width="100rem"></a>
                <h1>Pergunta de Segurança</h1>
                <div class="texto">
                    <label for="pergunta" class ="texto">Qual o seu CEP?</label>
                    <input type="text" name="resposta" class="required" placeholder="Informe o CEP cadastrado.">
